...
export function RecordingIndicator() {
  ...
  return (
    ...
    <View
      pointerEvents="none"
      style={{ position: 'absolute', top: 0, left: 0, right: 0, paddingTop: insets.top, zIndex: 9999, elevation: 9999 }}
    >
      <View style={{ backgroundColor: RECORDING_RED }} className="flex-row items-center justify-center gap-2 py-1.5">
        <Animated.View style={[dotStyle, { width: 8, height: 8, borderRadius: 999, backgroundColor: '#fff' }]} />
        <MicIcon size={13} color="#fff" />
        <Text style={{ color: '#fff' }} className="font-mono text-xs tracking-[1px]">
          正在录音…
        </Text>
      </View>
    </View>
