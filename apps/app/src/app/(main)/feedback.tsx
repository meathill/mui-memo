		...
		<SafeAreaView className="flex-1 bg-paper" edges={["top"]}>
			...
			>
				...
				>
					...
					<Text className="mt-5 font-mono text-ink-mute text-xs uppercase tracking-[2px]">
						联系方式（选填）
					</Text>
					<TextInput
						value={contact}
					...
					<View className="mt-2 flex-row flex-wrap gap-2">
						{TAG_OPTIONS.map((tag) => {
							...
							return (
								...
								>
									<Text
										className={`font-mono text-xs ${selected ? "text-paper" : "text-ink-mute"}`}
									>
										{tag}
									</Text>
								</Pressable>
