...
export const EXPLAINERS: Explainer[] = [
  {
    ...
    body: '你说的是一句大白话，叨叨记记住的是一件待办。动作、对象、时间线索都会被拆出来，而不是整句原样躺着。',
  },
  {
    n: '02',
...
export const SCENES: Scene[] = [
  ...
  },
  {
    ...
    effect: '叨叨记会把“去打疫苗”和“带出生证”一起收住，挂到明早那一段。临出门前看一眼，不必再回想刚才脑子里那句原话。',
  ...
  },
  {
    ...
    line: '开始做 A 客户的 logo。',
    effect:
      '一句“开始做 A 客户”，叨叨记就把这个客户相关的任务往前提，别的先安静下来。不是多一个系统，而是少一点切换成本。',
...
export const ROADMAP: Array<{
  ...
  },
  {
    n: 'Phase 3',
    title: '日常延伸',
    body: 'iCloud 同步、主屏小组件、一秒进入录音——让叨叨记藏在手指最顺手的地方。',
    phase: 'planned',
  },
  {
    n: 'Phase 4',
...
export const FAQ: Array<{ q: string; a: string }> = [
  ...
  {
    q: '我说的话会被拿去训练 AI 吗？',
    a: '叨叨记不会把你的内容公开给其他用户；当前语音会发送给 AI 做当次解析，相关录音和附件也可能存入你的账号数据。现在还没有自助清空输入记录的入口，如需删除归档数据或账号，请发邮件联系我。',
  },
  {
    q: '要收费吗？',
