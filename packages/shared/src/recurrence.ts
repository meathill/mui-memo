...
export function currentPeriodIndex(
	...
	if (freq === "monthly")
		return monthlyIndex(anchorMs, nowMs, interval, tzOffset);
...
export function periodStart(
	...
	const anchorMs = anchorAt.getTime();
	if (freq === "monthly")
		return new Date(monthlyStartMs(anchorMs, index, interval, tzOffset));
